...
4. STATE.md (if present)
5. DECISIONS.md (if present)

## OpenClaw Note Consultation

- Consult openclaw_notes/ only at session start or when the user explicitly asks about them.
- Do not read openclaw_notes/ during ordinary implementation work.
- If consulted, triage notes before planning new implementation work.
...
9. Never delete OpenClaw notes silently; preserve traceability.
